...
counts_matrix <- list.cbind(l_visits) %>% select(-contains("GeneName"))
...
#     c("BCL6", "IL10", "VEGFA")
# )
top_genes <- list.map(l_de2, get_top0(., n = 10))
