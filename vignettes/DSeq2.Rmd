...
# name_immu1 <- c("neutrophil", "natural killer cell", "macrophage", "leukocyte", " [BT] cell")
# name_immu1 <- c("(complement)|(C2 )", "(immune)|(inflammatory)", "mhc", "STAT[ 35]", "(tumor necrosis factor)|(TNF)(NF-k)", "phago((cytosis)|(some))", "(Toll-like)|(TLR )", "WNT", "(TNF-alpha)|(NF-k(appa)?B)")
